...
from .protocol import Protocol, decode_config, decode_pressure, decode_pressures, decode_interval, decode_errors
...
class DCP3000:
    ...
    def recording_time_interval(self, value: int = None):
        ...
        return decode_interval(self.write_readline('IN_SP_2'))
    ...
    def _set_point(self, channel: int, on_off: bool, value: (float, 'mbar') = None):
        ...
        return self.write_readline('IN_SP_{}{}'.format(on_off, channel))
